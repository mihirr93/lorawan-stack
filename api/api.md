...
| `auto_update_location` | [`bool`](#bool) |  | update the location of this gateway from status messages |
| `auto_update_location_debounce_time` | [`google.protobuf.Duration`](#google.protobuf.Duration) |  | debounce time for gateway location updates from status messages. |
