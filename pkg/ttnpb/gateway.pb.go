...
type Gateway struct {
	...
	AutoUpdateLocation bool `protobuf:"varint,21,opt,name=auto_update_location,json=autoUpdateLocation,proto3" json:"auto_update_location,omitempty"`
	// debounce time for gateway location updates from status messages.
	AutoUpdateLocationDebounceTime *time.Duration `protobuf:"bytes,22,opt,name=auto_update_location_debounce_time,json=autoUpdateLocationDebounceTime,proto3,stdduration" json:"auto_update_location_debounce_time,omitempty"`
	XXX_NoUnkeyedLiteral           struct{}       `json:"-"`
	XXX_sizecache                  int32          `json:"-"`
}
...
func (m *Gateway) GetAutoUpdateLocation() bool {
	if m != nil {
		return m.AutoUpdateLocation
	}
	return false
}

func (m *Gateway) GetAutoUpdateLocationDebounceTime() *time.Duration {
	if m != nil {
		return m.AutoUpdateLocationDebounceTime
	}
	return nil
}
...
var fileDescriptor_1df6bae1ac946b39 = []byte{
	...
	,
}
...
func (this *Gateway) Equal(that interface{}) bool {
	...
	if this.AutoUpdateLocation != that1.AutoUpdateLocation {
		return false
	}
	if this.AutoUpdateLocationDebounceTime != nil && that1.AutoUpdateLocationDebounceTime != nil {
		if *this.AutoUpdateLocationDebounceTime != *that1.AutoUpdateLocationDebounceTime {
			return false
		}
	} else if this.AutoUpdateLocationDebounceTime != nil {
		return false
	} else if that1.AutoUpdateLocationDebounceTime != nil {
		return false
	}
	return true
}
...
func (m *Gateway) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.AutoUpdateLocationDebounceTime != nil {
		n3, err3 := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.AutoUpdateLocationDebounceTime, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(*m.AutoUpdateLocationDebounceTime):])
		if err3 != nil {
			return 0, err3
		}
		i -= n3
...
func NewPopulatedGateway(r randyGateway, easy bool) *Gateway {
	...
	this.AutoUpdateLocation = bool(r.Intn(2) == 0)
	if r.Intn(5) != 0 {
		this.AutoUpdateLocationDebounceTime = github_com_gogo_protobuf_types.NewPopulatedStdDuration(r, easy)
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func (m *Gateway) Size() (n int) {
	...
	if m.AutoUpdateLocationDebounceTime != nil {
		l = github_com_gogo_protobuf_types.SizeOfStdDuration(*m.AutoUpdateLocationDebounceTime)
		n += 2 + l + sovGateway(uint64(l))
	}
	return n
}
...
func (this *Gateway) String() string {
	...
	s := strings.Join([]string{`&Gateway{`,
		...
		`AutoUpdateLocation:` + fmt.Sprintf("%v", this.AutoUpdateLocation) + `,`,
		`AutoUpdateLocationDebounceTime:` + strings.Replace(fmt.Sprintf("%v", this.AutoUpdateLocationDebounceTime), "Duration", "types.Duration", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Gateway) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 21:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AutoUpdateLocation", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AutoUpdateLocation = bool(v != 0)
		case 22:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AutoUpdateLocationDebounceTime", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.AutoUpdateLocationDebounceTime == nil {
				m.AutoUpdateLocationDebounceTime = new(time.Duration)
			}
			if err := github_com_gogo_protobuf_types.StdDurationUnmarshal(m.AutoUpdateLocationDebounceTime, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
